        ...
        if user_input_main == "1":
            ...
            while user_input_product != 5:
                ...
                if user_input_product == "1":
                    ...
                    new_product = input("What product would you like to add? (Press 0 to cancel!) ")
                    
                    if new_product == "0":
                        menu_functions.product_menu()
                    update_functions.add_item_to_list(new_product, products)
                    save_functions.save_lists("products.txt", products)
                    
                elif user_input_product == "3":
                    update_product = input("What product would you like to update? (Press 0 to cancel!)")
                    
                    if update_product == "0":
                        menu_functions.product_menu()
                    updated_product = input("What would you like to update this to? (Press 0 to cancel!)")
                    
                    if update_product == "0":
                        menu_functions.product_menu()
                    update_functions.update_item_in_list(update_product, updated_product, products)
                    ...
                    if delete_product == "0":
                        menu_functions.product_menu()
                    update_functions.delete_item_in_list(delete_product, products)
